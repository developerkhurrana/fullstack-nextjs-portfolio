...
const WHATSAPP_URL =
  "https://wa.me/917972816234?text=" +
  encodeURIComponent(
    "Hi Kshitij! I found your portfolio and would love to connect about a project or role."
  );
          ...
          <div className="max-w-md">
            ...
            <div className="mt-6">
              <a
                ...
                className="inline-flex items-center gap-2 rounded-full bg-[#25D366] px-5 py-2.5 text-sm font-semibold text-black transition-transform hover:-translate-y-0.5"
              >
